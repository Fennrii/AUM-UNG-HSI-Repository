...
def record_output(oa_ae, aa_ae, kappa_ae, element_acc_ae, training_time_ae, testing_time_ae, total_time_ae, path):
    f = open(path, 'a')
    ...
    f.write(sentence7)
    newSentence = 'Total average time is: ' + str(np.sum(total_time_ae)) + '\n' + '\n'
    f.write(newSentence)
